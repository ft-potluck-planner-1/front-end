...
//     const { // should these be props or state? - try using useState
//         values,
//         submit, 
//         change,
//         disabled,
...
//     const Onchange = evt => { //Onchange should be lowercase because it's not a component. And capital C b/c camelCase
//         const { name, value, checked, type } = evt.target
//         const valueToUse = type === 'checkbox' ? checked : value
//         change(name, ValueToUse) // valueTOUse should start with lowercase: camelCase rules
//     }
